    ...
    var _loop = function _loop() {
      ...
      trigger.onclick = function (e) {
        ...
        if (trigger.hasAttribute("bodyfix")) {
          document.querySelectorAll('body')[0].classList.toggle("fix");
        }

        var targetClasses = trigger.getAttribute("targets").split(' ');

        var _iterator9 = _createForOfIteratorHelper(targetClasses),
            _step9;

        try {
          for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
            var targetClass = _step9.value;
  ...
  try {
    var _loop2 = function _loop2() {
      ...
      trigger.onclick = function (e) {
        ...
        var _iterator11 = _createForOfIteratorHelper(contactsTriggers),
            _step11;
        ...
        var _iterator12 = _createForOfIteratorHelper(tabs),
            _step12;
