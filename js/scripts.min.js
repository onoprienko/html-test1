...
(function start() {
  ...
  var swiper = new Swiper(".slider__cards", {
    ...
    loop: true,
    navigation: {
      nextEl: ".more-clients__next",
      prevEl: ".more-clients__prev"
    },
    coverflowEffect: {
      rotate: 50,
      stretch: 80,
  ...
  if (window.innerWidth >= 992) {
    var swiper = new Swiper(".slider__blog", {
      slidesPerView: "auto",
      spaceBetween: 0,
      centeredSlides: true,
      loop: true,
  ...
  var customSelectEl = document.getElementsByClassName('select');

  var _iterator = _createForOfIteratorHelper(customSelectEl),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var scrollEl = _step.value;
      var cstSel = scrollEl.customSelect;
      cstSel.container.addEventListener('custom-select:open', function (e) {
        setCustomScroll();
      });
    } //customselect end
    //custom scroll
  ...
  var setCustomScroll = function setCustomScroll() {
    var customScrollEl = document.getElementsByClassName('select-c__panel');

    var _iterator2 = _createForOfIteratorHelper(customScrollEl),
        _step2;

    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var scrollEl = _step2.value;
  ...
  if (grid) {
    var initMasonry = function initMasonry() {
      ...
      var bannerFix = function bannerFix() {
        var elems = msnry.getItemElements();
        elems.forEach(function (el) {
          if (el.offsetLeft > 0 && el.classList.contains('case-banner')) {
            el.classList.add('case-banner_right');
          }
        });
      };
    ...
    var stopMasonry = function stopMasonry() {
      var _msnry;

      (_msnry = msnry) !== null && _msnry !== void 0 && _msnry.element ? msnry.destroy() : null;
      grid.getElementsByClassName('case-banner').forEach(function (el) {
        el.classList.remove('case-banner_right');
      });
    };

    window.addEventListener("resize", function () {
      setTimeout(function () {
        window.innerWidth > 992 ? initMasonry() : stopMasonry();
      }, 200);
    });
    window.innerWidth > 992 ? initMasonry() : stopMasonry();
  } //masonry end
  ...
  try {
    var _loop = function _loop() {
      ...
      trigger.onclick = function (e) {
        ...
        var _iterator10 = _createForOfIteratorHelper(targetClasses),
            _step10;

        try {
          for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
            var targetClass = _step10.value;
  ...
  var selectContry = document.querySelector('[select-country]');

  if (selectContry) {
    selectContry.addEventListener('change', function (event) {
      console.log(event.target.value);

      var _iterator4 = _createForOfIteratorHelper(document.querySelectorAll('[contact-country]')),
          _step4;
      ...
      var curentFilter = document.querySelector("[contact-country=\"".concat(event.target.value, "\"]"));
      curentFilter.classList.add("active");
      curentFilter.querySelectorAll(".filter__tag")[0].click();
    });
  }

  var contactsTriggers = document.querySelectorAll('[contacts-trigger]');

  var _iterator5 = _createForOfIteratorHelper(contactsTriggers),
      _step5;
  ...
  try {
    var _loop2 = function _loop2() {
      ...
      trigger.onclick = function (e) {
        ...
        var _iterator12 = _createForOfIteratorHelper(contactsTriggers),
            _step12;
        ...
        var targetClass = trigger.getAttribute("target");
        var targets = document.getElementsByClassName(targetClass);
        var tabs = document.querySelectorAll('[tab]');

        var _iterator13 = _createForOfIteratorHelper(tabs),
            _step13;
        ...
        var lat = Number(trigger.getAttribute("lat"));
        var lng = Number(trigger.getAttribute("lng"));
        initMap({
          lat: lat,
          lng: lng
        });
  ...
  var _iterator6 = _createForOfIteratorHelper(closePopup),
      _step6;
  ...
  try {
    var _loop3 = function _loop3() {
      ...
      close.onclick = function (e) {
        ...
        document.querySelectorAll('body')[0].classList.remove("fix");
      };
    };
  ...
  var _iterator7 = _createForOfIteratorHelper(tx),
      _step7;
  ...
  } //textarea autoheight end
  //input file


  var inputsFile = document.querySelectorAll("[type='file']");

  var _iterator8 = _createForOfIteratorHelper(inputsFile),
      _step8;

  try {
    for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
      var inputFile = _step8.value;
      inputFile.addEventListener('change', function (e) {
        console.log(e.target.files);
        var inputDiv = e.target.parentNode;
        var fileList = inputDiv.querySelectorAll(".input-file__filelist")[0];
        fileList.innerHTML = "";
        e.target.files.forEach(function (file) {
          var fileNodeClone = inputDiv.querySelectorAll(".input-file__example .input-file__file")[0].cloneNode(true);
          fileNodeClone.querySelectorAll(".input-file__filename")[0].innerHTML = file.name;
          fileList.appendChild(fileNodeClone);
        });
      });
    } //input file end
    //scrollto
  ...
  if (document.querySelectorAll(".head-index__scrolldown")[0]) {
    document.querySelectorAll(".head-index__scrolldown")[0].onclick = function (e) {
      e.preventDefault();
      document.querySelectorAll(".index-info")[0].scrollIntoView({
        block: "center",
        behavior: "smooth"
      });
    };
  ...
  if (header) {
    window.addEventListener("scroll", function () {
      ...
      if (currentScroll > lastScroll) {
        currentScroll >= "100" ? header.classList.add("hide") : null;
      } else if (currentScroll < lastScroll) {
        header.classList.remove("hide");
        header.classList.add("show-bg");
        currentScroll <= "100" ? header.classList.remove("show-bg") : null;
      }
  ...
  document.addEventListener('aos:in:statistics', function (_ref) {
  ...
  var counterStart = function counterStart(el) {
    var counter = el.querySelector(".counter");
    counter.innerText = 0;
    var duration = 0.6; //s

    var updateCount = function updateCount(cointer) {
      var target = +counter.getAttribute('data-target');
      var count = +counter.innerText;
      var inc = target / (duration * 10); // console.log("target", target);
      // console.log("count", count);
      // console.log("inc", inc);

      if (count < target) {
        counter.innerText = Math.ceil(count + inc); //console.log(count + inc)
  ...
  var tooltipButtons = document.querySelectorAll('.popper');

  var _iterator9 = _createForOfIteratorHelper(tooltipButtons),
      _step9;

  try {
    var _loop4 = function _loop4() {
      var button = _step9.value;
      var tooltip = button.querySelector('.popper__content');
